...
public class StateTest extends student.TestCase {
     ...
     */
    public void setUp() {
        int[] cases = new int[] { 70678, 179563, 97118, 5407, 108784 };
        int[] deaths = new int[] { 1924, 13365, 2269, 254, 170 };
        state1 = new State("DC", cases, deaths);
        int[] casesWithNA = new int[] { 616402, -1, 738177, -1, 77733 };
        int[] deathsWithNA = new int[] { 4311, 14702, -1, -1, 5745 };
